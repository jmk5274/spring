...
<body>
	...
	<h3>pathvariable</h3>
	<form id="frm">
		brown:<input type="radio" name="path" value="brown" checked/>
	...
	<form action="${cp }/mvc/multiParameter" method="post">
		...
		<input type="text" name="addrList[0].addr1" value="대전시 중구 중앙로 761"/><br>
		<input type="text" name="addrList[0].addr2" value="DDIT1"/><br>
		
		<input type="text" name="addrList[1].addr1" value="대전시 중구 중앙로 762"/><br>
